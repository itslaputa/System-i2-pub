...
[Скачать](#скачать) · [Возможности](#возможности) · [Приватность](#приватность-и-данные) · [Для разработчиков](#для-разработчиков)
...
System-I2 сделан для людей, которым нужен простой локальный журнал работы без превращения его в командную доску задач или облачный сервис.

С его помощью можно отвечать на практические вопросы:

- На что ушло время на этой неделе?
- Какие проекты требуют больше всего усилий?
- Какие категории работы растут со временем?
- Какой контекст был у конкретной рабочей записи?

Основной сценарий:

- Записывать рабочие сессии с датой, длительностью, категорией, проектом и комментарием.
- Группировать работу по устойчивым категориям для долгосрочной аналитики.
- Вести глобальные проекты, которые могут включать задачи из разных категорий.
- Смотреть время по периодам, категориям, проектам и трендам.
- Хранить все данные в локальной папке с SQLite/JSON-файлами.
- Создавать zip-бэкап активной локальной папки данных из приложения.

## Для кого

System-I2 подходит для личного учёта работы, исследовательских заметок, одиночных проектов, фриланса, учёбы и любых процессов, где локальная история времени полезнее общей доски задач.

Это не командный менеджер проектов, не замена календаря, не система выставления счетов и не облачная аналитика.
...
Записывайте, над чем работали, сколько времени это заняло, к какой категории относится запись, какой проект она поддерживает и какой контекст нужно сохранить.

### Категории

Поддерживайте редактируемое дерево категорий задач. ID категорий остаются стабильными для аналитики, а названия можно менять по мере изменения рабочего процесса.

### Проекты

Создавайте глобальные проекты независимо от категорий задач. Один проект может собирать работу из разных категорий, поэтому по нему удобно смотреть реальную цену большой цели.

### Аналитика

Смотрите залогированное время по периодам, категориям, проектам и трендам. Приложение сделано для личного анализа: что заняло время, что изменилось и куда ушло внимание.

### Локальная папка данных

Данные живут в локальной папке с SQLite и JSON-файлами. При первом запуске можно создать новую папку данных или подключить существующую.
